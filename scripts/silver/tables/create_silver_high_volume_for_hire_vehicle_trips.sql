/*
-- Script: create_silver_high_volume_for_hire_vehicle_trips.sql
-- Dataset: silver
-- Table: high_volume_for_hire_vehicle_trips
-- Source Table: nyc-trips-analytics.bronze.high_volume_for_hire_vehicle_trips
...
WITH high_volume_for_hire_vehicle AS(
  ...
  FROM
    `nyc-trips-analytics.bronze.high_volume_for_hire_vehicle_trips`
)
SELECT
  trip_id,
  hvfhs_license_num,
